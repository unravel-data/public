...
wget https://unravelstorage01.blob.core.windows.net/unravel-app-blob-2018-04-13/unravel-tez-package.tar.gz  -O /usr/local/unravel-tez-package.tar.gz
cd  /usr/local
