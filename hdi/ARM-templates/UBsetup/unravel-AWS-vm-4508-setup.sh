# Download unravel 4.5.0.8 latest rpm
RPMFILE=`curl -sS -u unravel:WillowRoad68 https://preview.unraveldata.com/unravel/staging-RPM/4.5.0/  |grep EMR |awk '{ print $6}' |cut -d\" -f2  |grep 4.5.0.8 |tail -1`
