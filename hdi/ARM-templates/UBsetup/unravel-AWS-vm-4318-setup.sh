...
curl -u https://preview.unraveldata.com/unravel/RPM/4.3.1/Azure/unravel-4.3.1.8b0003-1.x86_64.EMR.rpm -o unravel-4.3.1.8b0003-1.x86_64.EMR.rpm
...
# install unravel rpm
/usr/bin/rpm  -U unravel-4.3.1.8b0003-1.x86_64.EMR.rpm
